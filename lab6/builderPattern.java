//Суть паттерна "Строитель" заключается в разделении процесса конструирования
// объекта на отдельные шаги, при этом каждый шаг выполняется через специализированный интерфейс
